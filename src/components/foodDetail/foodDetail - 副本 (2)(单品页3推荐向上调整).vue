      ...
      <!-- 推荐汤品 -->
        ...
        <!-- 推荐甜品 -->
          <div v-if="this.food.flag==2" class="contentbox">
            <div class="foodpicbox" style="width: 100%; height: 4rem; overflow: hidden; position: relative;"><img :src="food.images.source_image" class="foodpic" style="width:100%;"><div class="title txtcenter"><span class="big">一</span><span class="log">&nbsp;</span>推荐甜品&nbsp;&nbsp;<span class="big">一</span></div></div>
            <div class="bgbox">
              <div class="tuijian">
...
<div class="cjchange">
    <ul class="cjchange-list">
        ...
        <li  @click="selectCj(2)" :class="{'on':food.flag==2 }" :key="3">推荐甜品</li>
