    ...
    <div class="dggbox">
        <div class="dgg" :class="{dgg2show:Descshow}">
            ...
            <div class="dgg-total">
                ...
                <div v-if="childfood.button_name!=''" class="dgg-total-btn" @click="addCart($event)">{{childfood.button_name}}</div>
                <div v-else class="dgg-total-btn" @click="addCart($event)">来一份</div>
            </div>
        </div>
    </div>
</template>
