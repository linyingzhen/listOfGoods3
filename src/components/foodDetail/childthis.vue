    ...
    <div class="dggbox">
        <div class="dgg" :class="{dgg2show:Descshow}">
            <div class="dgg-food">
              ...
              <!-- <span class="dgg-food-title">{{childfood.name}}  <div v-if="food.label" class="subname">{{food.label}}</div></span> -->
            ...
            <div class="dgg-kwei" v-if="childfood.kwei.length>1">
                ...
                <ul class="dgg-kwei-list">
                    <li v-for="(kwei,kweiindex) in childfood.kwei" @click="selectKwei(kweiindex)" :class="{'on':flag==kweiindex }" :key="food.meal_id">{{kwei.name}}</li>
                </ul>
            </div>
            <div class="cf">
              <span>标配 &nbsp;</span><span v-if="childfood.label" class="subname">( {{childfood.label}} )</span><span class="cf_price">{{childfood.price*1}}</span>
            </div>
            ...
            <!-- <div class="dgg-total">
                ...
                <div v-if="childfood.button_name!=''" class="dgg-total-btn" @click="addCart($event)">&yen;{{ childfood.totalprice*1 }} {{childfood.button_name}}</div>
                <div v-else class="dgg-total-btn" @click="addCart($event)">&yen;{{ childfood.totalprice*1 }} 来一份</div>
            </div> -->
        </div>
    </div>
</template>
