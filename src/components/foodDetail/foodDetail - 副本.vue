    ...
    <div v-else v-show="showDetail">
      ...
      <div class="detailWrapper" ref="detailWrapper">
        <div class="foodDetail">
          ...
          <div class="divider"></div>
          <div class="tuijian">
            <div v-if="food.tjtangpins && food.store_id=='21'" class="title"><span class="big">一</span><span class="log">&nbsp;</span>精选汤品&nbsp;&nbsp;<span class="big">一</span></div>
            <div v-if="food.tjtangpins && food.store_id!='21'" class="title"><span class="big">一</span><span class="log">&nbsp;</span>推荐汤品&nbsp;&nbsp;<span class="big">一</span></div>
          ...
          <div class="divider"></div>
          <div class="tuijian">
            <div v-if="food.tjtianpins && food.store_id=='21'" class="title"><span class="big">一</span><span class="log">&nbsp;</span>客家大埔名吃&nbsp;&nbsp;<span class="big">一</span></div>
            <div v-if="food.tjtianpins && food.store_id!='21'" class="title"><span class="big">一</span><span class="log">&nbsp;</span>推荐甜品&nbsp;&nbsp;<span class="big">一</span></div>
          ...
          <div class="divider"></div>
          <div class="tuijian">
            <div v-if="food.tjgongfuchas && food.store_id=='21'" class="title"><span class="big">一</span><span class="log">&nbsp;</span>精选功夫茶&nbsp;&nbsp;<span class="big">一</span></div>
            <div v-if="food.tjgongfuchas && food.store_id!='21'" class="title"><span class="big">一</span><span class="log">&nbsp;</span>推荐功夫茶(每泡/限6人内)&nbsp;&nbsp;<span class="big">一</span></div>
